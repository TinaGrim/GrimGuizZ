  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ width: 180, height: 180, border: "3px solid var(--color-amber)", borderRadius: "50%" }}
      />
      <div
        className="absolute bottom-16 right-12 opacity-5"
        style={{ width: 100, height: 100, background: "var(--color-ember)", transform: "rotate(20deg)" }}
      />
      <div
      ...
      <div className="flex flex-col items-center gap-8 w-full max-w-md">
        <div className="text-center">
          <p
            ...
            style={{ color: "var(--color-ember)", fontFamily: "var(--font-body)", letterSpacing: "0.2em" }}
          >
            {quiz.title}
          </p>
          <h1
