  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderLeft: `5px solid ${answer.correct ? "var(--color-success)" : "var(--color-danger)"}`,
                  ...
                  <div className="flex items-start gap-4 p-5">
                    <div
                      ...
                      style={{
                        width: 28,
                        height: 28,
                        background: answer.correct ? "var(--color-success)" : "var(--color-danger)",
                        color: "#fff",
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className="text-xs"
                            style={{
                              color: answer.correct ? "var(--color-success)" : "var(--color-danger)",
        ...
        {/* CTA */}
        {showBreakdown && (
          <div className="flex gap-3 mt-8 animate-slide-up" style={{ animationDelay: "0.5s", animationFillMode: "both" }}>
            <button
